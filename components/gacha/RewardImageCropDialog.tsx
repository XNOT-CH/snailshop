...
export function RewardImageCropDialog({
    ...
    const resetCropRect = () => {
        ...
        const size = Math.max(Math.min(Math.min(image.clientWidth, image.clientHeight) * 0.68, image.clientWidth, image.clientHeight), MIN_CROP_SIZE);
        setCropRect({
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="rounded-[24px] border border-slate-200 bg-slate-50/90 p-4">
                                ...
                                <div className="mt-4 flex justify-center">
                                    <div
                                        className="relative h-28 w-28 overflow-hidden rounded-full border-4 border-amber-400 bg-white shadow-[0_12px_32px_-18px_rgba(251,191,36,0.9)]"
                                    >
                                        {previewSrc ? (
                                            <>
                                                {/* eslint-disable-next-line @next/next/no-img-element */}
