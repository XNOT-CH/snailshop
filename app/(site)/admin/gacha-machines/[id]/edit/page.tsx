...
export default function EditGachaMachinePage() {
    ...
    const loadRewards = useCallback(async () => {
        ...
        try {
            const { data: json } = await fetchAdminGachaRewards<GachaReward[]>({ machineId: id });
    ...
    const handleAddReward = async () => {
        ...
        try {
            ...
            const { data: json } = await createAdminGachaReward(body);
            if (json.success) {
    ...
    const uploadRewardImage = useCallback(async (
        ...
        try {
            ...
            const { data: json } = await uploadAdminGachaRewardImage(preparedFile);
    ...
    const handleDeleteReward = async (rewardId: string) => {
        ...
        try {
            await deleteAdminGachaReward(rewardId);
            void loadRewards();
    ...
    const handleEditSave = async () => {
        ...
        try {
            const { data: json } = await updateAdminGachaReward(editReward.id, body);
