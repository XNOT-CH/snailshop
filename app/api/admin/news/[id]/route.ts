...
export async function GET(_req: Request, { params }: RouteParams) {
    ...
    try {
        ...
        if (!news) return contentApiError("News not found", { status: 404 });
        return NextResponse.json(news);
    } catch { return contentApiError("Failed to fetch news", { status: 500 }); }
}
...
export async function PUT(request: Request, { params }: RouteParams) {
    ...
    try {
        ...
        if (!oldNews) return contentApiError("News not found", { status: 404 });
    ...
    } catch { return contentApiError("Failed to update news", { status: 500 }); }
}
...
export async function DELETE(request: Request, { params }: RouteParams) {
    ...
    } catch { return contentApiError("Failed to delete news", { status: 500 }); }
}
