// One-off runner for drizzle/0028_user_last_login.sql
// Applies the idempotent User.lastLoginAt column + index on a single connection
...
const sql = fs.readFileSync(path.resolve("drizzle/0028_user_last_login.sql"), "utf8");
