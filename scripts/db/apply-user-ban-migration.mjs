// One-off runner for drizzle/0026_user_account_ban.sql
// Applies the idempotent User.bannedAt / banReason columns on a single
...
const sql = fs.readFileSync(path.resolve("drizzle/0026_user_account_ban.sql"), "utf8");
