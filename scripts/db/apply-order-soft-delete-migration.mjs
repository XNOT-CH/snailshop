// One-off runner for drizzle/0027_order_soft_delete.sql
// Applies the idempotent Order.deletedAt column + index on a single connection
...
const sql = fs.readFileSync(path.resolve("drizzle/0027_order_soft_delete.sql"), "utf8");
