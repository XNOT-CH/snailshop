...
export const PERMISSIONS = {
    ...
    // Topup code (credit code redemption) permissions
    TOPUP_CODE_VIEW: "slip:view",
    TOPUP_CODE_APPROVE: "topupcode:approve",
    TOPUP_CODE_REJECT: "topupcode:reject",
...
export const PERMISSION_DEPENDENCIES: Partial<Record<Permission, Permission[]>> = {
    ...
    [PERMISSIONS.TOPUP_CODE_VIEW]: [PERMISSIONS.ADMIN_PANEL],
    [PERMISSIONS.TOPUP_CODE_APPROVE]: [PERMISSIONS.TOPUP_CODE_VIEW],
    [PERMISSIONS.TOPUP_CODE_REJECT]: [PERMISSIONS.TOPUP_CODE_VIEW],
    ...
    [PERMISSIONS.AUDIT_LOG_DELETE]: [PERMISSIONS.AUDIT_LOG_VIEW],
...
export const ROLE_PERMISSIONS: Record<string, Permission[]> = {
    ...
    MODERATOR: [
        ...
        PERMISSIONS.TOPUP_CODE_APPROVE,
        PERMISSIONS.TOPUP_CODE_REJECT,
