...
const ADMIN_PAGE_RULES: AdminAccessRule[] = [
    ...
    { path: "/admin/registration/", permission: PERMISSIONS.CONTENT_VIEW },
    { path: "/admin/promo-codes", permission: PERMISSIONS.PROMO_VIEW, exact: true },
    { path: "/admin/invite-codes", permission: PERMISSIONS.INVITE_VIEW, exact: true },
    ...
    { path: "/admin/slips", permission: PERMISSIONS.TOPUP_CODE_VIEW, exact: true },
...
const ADMIN_API_RULES: AdminAccessRule[] = [
    ...
    { path: "/api/admin/registration-policies", permission: PERMISSIONS.CONTENT_VIEW },
    { path: "/api/admin/promo-codes", permission: PERMISSIONS.PROMO_VIEW },
    { path: "/api/admin/invite-codes", permission: PERMISSIONS.INVITE_VIEW },
    { path: "/api/admin/gacha", permission: PERMISSIONS.GACHA_VIEW },
    { path: "/api/admin/season-pass", permission: PERMISSIONS.SEASON_PASS_VIEW },
    { path: "/api/admin/quests", permission: PERMISSIONS.QUEST_VIEW },
    ...
    { path: "/api/admin/slips", permission: PERMISSIONS.TOPUP_CODE_VIEW },
